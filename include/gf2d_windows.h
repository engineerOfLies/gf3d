...
{
    Uint8               _inuse;             /**<do not touch*/
    Uint8               hidden;             /**<if true, no drawing*/
    Uint8               disabled;           /**<if true, no drawing or updating*/
    GFC_TextLine        name;               /**<name of window*/
    Uint8               no_draw_generic;    /**<if true, do not use the generic window draw style*/
    Uint8               clipToWindow;       /**<if true, limit window element drawing to the window drawing area*/
    ...
    Uint8               blocks_input;       /**<if true, windows below will not be checked for input updates, but will update*/
